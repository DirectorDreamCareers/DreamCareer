            ...
            <div className='md:w-3/4 w-full mx-3 flex gap-16 md:mx-auto'>
                ...
                <div className='w-1/2 mr-6'>
                    ...
                    <p className='text-base font-normal text-justify my-3' style={{ color: '#3e3e3e' }}>
                        Dreeamcareers Services is one of the Top Consuting Organisations based out from Bangalore.<span className='hidden sm:inline'> We act as a building bridge between the job seekers and corporate clients, and work very dedicated and hard to ensure that both gets satisfied the needs and expectations.</span><span className='hidden md:inline'>We ensure this by taking the time to thoroughly understand the specific needs of each of our clients, and then use the best Industry Best Resource tool and techniques to shortlist the most suitable candidates and also understand the candiate career goals requirments and then advice the suitable positions thereby ensuring corporates get the right candidates and the candidate the right opportunity to perform.</span>
                    </p>
